...
import { Loader2, Mail, Shield, Clock, KeyRound, Info } from "lucide-react";
    ...
    <AppLayout>
      <div className="px-4 md:px-8 py-6 md:py-8 max-w-2xl">
        ...
        <div className="space-y-4">
          ...
          {/* Redeem access code — visible to all non-admin users */}
          {!isAdmin && (
            <div className="rounded-xl border border-border bg-card p-5 md:p-6 space-y-4">
          ...
          {/* Role info box — read-only notice for non-admins */}
          {!isAdmin && (
