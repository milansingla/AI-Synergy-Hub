...
const EVALUATION_DIMENSIONS = [
  { dimension: "Technical & Domain Knowledge", weight: 30, description: "Depth and accuracy of technical knowledge specific to the role — tools, frameworks, architectures, and domain concepts explicitly named in the JD. Generic answers that do not reference the JD's specific stack score low.", bar: "Candidate must name specific technologies from the JD and explain how and why they would use them. Superficial or textbook-level definitions are insufficient." },
  { dimension: "Communication & Articulation", weight: 15, description: "Clarity, structure, and professionalism. Ability to explain complex ideas concisely, maintain a logical thread, and use precise terminology without jargon overload.", bar: "Rambling, unclear, or one-sentence answers score 40 or below. Strong answers are structured, specific, and professional." },
  { dimension: "Problem-Solving & Analytical Thinking", weight: 20, description: "Ability to decompose real problems, reason through trade-offs, and propose data-driven solutions. Evaluated through situational and technical responses.", bar: "The candidate must walk through their reasoning step by step. Stating a conclusion without reasoning scores below 50." },
  { dimension: "Behavioural Competencies & STAR Quality", weight: 20, description: "Quality of behavioural examples. Must follow STAR (Situation, Task, Action, Result) with quantifiable results. Evidence of ownership, initiative, and delivery.", bar: "No STAR structure: cap at 55. Vague stories with no concrete result: cap at 45. Strong answers quantify the impact (e.g. 'reduced latency by 40%')." },
  { dimension: "Cultural Fit & Professional Attitude", weight: 10, description: "Genuine enthusiasm for THIS specific role and company, growth mindset, professionalism throughout. Assessed through motivation quality and questions asked.", bar: "Generic answers ('I want to grow') score below 50. Strong answers reference company-specific context from the JD." },
  { dimension: "Role & Company Alignment", weight: 5, description: "Degree to which the candidate's stated experience, goals, and motivation directly map to the specific responsibilities and expectations in this JD.", bar: "The candidate must connect their background to at least 2 specific responsibilities from the JD. Failure to do so scores below 55." },
];
...
• 90-100 — WORLD CLASS. Every single answer was specific, impressive, and demonstrated mastery well beyond what the role requires.
• 80-89  — STRONG HIRE. Clear mastery of the JD's core requirements, concrete examples, correct technical depth.
• 68-79  — CONDITIONAL HIRE. Meets baseline requirements in most areas. 1-2 notable gaps.
• 52-67  — BELOW BAR. Multiple vague, surface-level, or incomplete answers.
• 35-51  — WEAK. Frequent gaps in core competencies.
• 0-34   — NO HIRE. Did not demonstrate the minimum competencies for this role.

ANTI-INFLATION RULE: If your draft overallScore is above 75, challenge yourself — can you justify every point above 75 with specific evidence from the transcript?
...
- "feedback": 3-4 sentences hiring recommendation
- "strengths": array of exactly 3 items, each citing a specific answer
- "improvements": array of exactly 3 actionable items
- "criteriaScores": array of 6 objects: { "dimension", "score", "weight", "feedback" }
- "questionEvals": array of objects per Q&A: { "question", "answer", "score", "feedback", "idealAnswer" }
